...
@param initP1Score Player 1's Score */
	public ScrabbleGameState (ScrabbleTile[][] initBoard, ScrabbleTile[] initHand, int initPlayerToMove, int initP0Score, int initP1Score) {
